...
@Entity
@Table(name = "MDS_UAT.mdm.HOLDING_V_C")
public class Holding {
    ...
    public java.util.Date getLastChgDateTime() {
        return lastChgDateTime;
    }

    public void setLastChgDateTime(java.util.Date lastChgDateTime) {
        this.lastChgDateTime = lastChgDateTime;
    }
